...
public class UserService {
    ...
    public void validateRegistration(User user, String password, String confirm) throws ValidationException {
        ...
        if (!password.equals(confirm)) {
            throw new ValidationException("Password doesn't equal confirm");
        }
        String email = user.getEmail();
        if (Strings.isNullOrEmpty(email)) {
            throw new ValidationException("Email is required");
        }
        int DogSymbolCount = 0;
